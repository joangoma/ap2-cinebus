...
![alt text]([http://url/to/img.png](https://github.com/joangoma/ap2-cinebus/blob/main/menu.png))

### Features of the demo

1. **Show billboard**: View the current billboard displaying a list of films currently being screened in cinemas.
![alt text]([https://github.com/joangoma/ap2-cinebus/blob/main/billboard.png))
...
![alt text]([https://github.com/joangoma/ap2-cinebus/blob/main/filterbillboard.png))
...
![alt text]([https://github.com/joangoma/ap2-cinebus/blob/main/5.png))
![alt text]([https://github.com/joangoma/ap2-cinebus/blob/main/cami.png))
